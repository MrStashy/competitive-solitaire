...
export default function ControlModule({ handleNewGameClick, handleRestartClick, dealt, loadingNewGame, endGame }: ControlModuleProps) {
    ...
    if (dealt) {
        return (
            ...
            <button className={style} onClick={() => endGame()}>Give Up</button>
            </div>
            </div>
        )
    }
